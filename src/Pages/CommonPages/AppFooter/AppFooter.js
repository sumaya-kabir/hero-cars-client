...
const AppFooter = () => {
    return (
        <footer className="w-100 bg-dark text-light row row-cols-1 row-cols-sm-2 row-cols-md-5 p-5 border-top">
            

                <div className="col mb-3 text-center">
                    <Link to="/" className="d-flex align-items-center justify-content-center mt-5 fs-2 link-light text-decoration-none">
